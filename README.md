...
Just here to sensibilised about this type of Scam. 
I don't encourage anyone to use this code/scipt for illegal uses. 
The scam work with TRON blockchain is this example but works with every blockchain that have a Multisig option. 
